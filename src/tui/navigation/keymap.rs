...
pub fn mode_keymap(
    ...
    let (mode_label, fkey_vis, hints) = match mode {
        TuiMode::Overview => (
            ...
            vec![
                InlineHint { key: "Enter", action: "Detail", priority: 0 },
                InlineHint { key: "d", action: "Dismiss", priority: 1 },
                InlineHint { key: "f", action: "Full", priority: 2 },
                InlineHint { key: "w", action: "Switcher", priority: 3 },
                InlineHint { key: "Tab", action: "Cycle Views", priority: 4 },
            ],
        ),
        TuiMode::Detail(_) => (
            "Detail",
            FKeyVis::SessionAware,
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "f", action: "Full", priority: 1 },
                InlineHint { key: "l", action: "Logs", priority: 2 },
                InlineHint { key: "k", action: "Kill", priority: 3 },
            ],
        ),
        TuiMode::Fullscreen(_) => (
            ...
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "j/k", action: "Scroll", priority: 1 },
            ],
        ),
        TuiMode::Dashboard => (
            "Dashboard",
            ...
            vec![
                InlineHint { key: "i", action: "Issues", priority: 0 },
                InlineHint { key: "m", action: "Milestones", priority: 1 },
                InlineHint { key: "r", action: "Prompt", priority: 2 },
                InlineHint { key: "s", action: "Settings", priority: 3 },
                InlineHint { key: "a", action: "Adapt", priority: 4 },
            ],
        ),
        TuiMode::IssueBrowser => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Launch", priority: 0 },
                InlineHint { key: "/", action: "Filter", priority: 1 },
                InlineHint { key: "Space", action: "Select", priority: 2 },
                InlineHint { key: "Esc", action: "Back", priority: 3 },
            ],
        ),
        TuiMode::MilestoneView => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Select", priority: 0 },
                InlineHint { key: "i", action: "Issues", priority: 1 },
                InlineHint { key: "Esc", action: "Back", priority: 2 },
            ],
        ),
        TuiMode::PromptInput => (
            "Prompt Input",
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Submit", priority: 0 },
                InlineHint { key: "Ctrl+J", action: "Newline", priority: 1 },
                InlineHint { key: "Esc", action: "Cancel", priority: 2 },
            ],
        ),
        TuiMode::Settings => (
            "Settings",
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Tab", action: "Next", priority: 0 },
                InlineHint { key: "Enter", action: "Toggle", priority: 1 },
                InlineHint { key: "Esc", action: "Back", priority: 2 },
            ],
        ),
        TuiMode::CostDashboard => (
            ...
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "Tab", action: "Cycle Views", priority: 1 },
            ],
        ),
        ...
        TuiMode::CompletionSummary => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "i", action: "Browse", priority: 0 },
                InlineHint { key: "r", action: "New Prompt", priority: 1 },
                InlineHint { key: "d", action: "Dashboard", priority: 2 },
                InlineHint { key: "q", action: "Quit", priority: 3 },
            ],
        ),
        TuiMode::LogViewer(_) => (
            "Log Viewer",
            ...
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "j/k", action: "Scroll", priority: 1 },
                InlineHint { key: "G", action: "Bottom", priority: 2 },
                InlineHint { key: "g", action: "Top", priority: 3 },
            ],
        ),
        TuiMode::SessionSummary => (
            ...
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "j/k", action: "Navigate", priority: 1 },
                InlineHint { key: "Enter", action: "Expand", priority: 2 },
            ],
        ),
        TuiMode::SessionSwitcher => (
            ...
            vec![
                InlineHint { key: "Enter", action: "Select", priority: 0 },
                InlineHint { key: "Esc", action: "Cancel", priority: 1 },
            ],
        ),
        TuiMode::ConfirmKill(_) => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "y", action: "Confirm", priority: 0 },
                InlineHint { key: "n", action: "Cancel", priority: 1 },
            ],
        ),
        TuiMode::QueueConfirmation => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Confirm", priority: 0 },
                InlineHint { key: "Esc", action: "Cancel", priority: 1 },
            ],
        ),
        TuiMode::QueueExecution => (
            ...
            vec![
                InlineHint { key: "Esc", action: "Back", priority: 0 },
                InlineHint { key: "r", action: "Retry", priority: 1 },
                InlineHint { key: "s", action: "Skip", priority: 2 },
            ],
        ),
        TuiMode::HollowRetry => (
            "Hollow Retry",
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Retry", priority: 0 },
                InlineHint { key: "Esc", action: "Cancel", priority: 1 },
            ],
        ),
        TuiMode::ContinuousPause => (
            ...
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "r", action: "Retry", priority: 0 },
                InlineHint { key: "Esc", action: "Back", priority: 1 },
            ],
        ),
        TuiMode::AdaptWizard => (
            "Adapt Wizard",
            FKeyVis::Minimal,
            vec![
                InlineHint { key: "Enter", action: "Next", priority: 0 },
                InlineHint { key: "Esc", action: "Back", priority: 1 },
            ],
        ),
        TuiMode::PrReview => (
...
fn build_fkeys(
    ...
    match vis {
        FKeyVis::SessionAware => vec![
            FKeyRelevance { key: "F1", label: "Help", visible: true, active: true },
            FKeyRelevance { key: "F2", label: "Summary", visible: true, active: true },
            FKeyRelevance { key: "F3", label: "Full", visible: true, active: has_session },
            FKeyRelevance { key: "F4", label: "Costs", visible: true, active: true },
            FKeyRelevance { key: "F5", label: "Tokens", visible: true, active: true },
            FKeyRelevance { key: "F6", label: "Deps", visible: true, active: true },
            FKeyRelevance { key: "F9", label: "Pause", visible: true, active: is_running },
            FKeyRelevance { key: "F10", label: "Kill", visible: true, active: has_session && !is_terminal },
            FKeyRelevance { key: "^X", label: "Exit", visible: true, active: true },
        ],
...
mod tests {
    ...
    fn mode_keymap_overview_completed_session_dims_pause_kill() {
        ...
        let f9 = km.fkeys.iter().find(|f| f.key == "F9").unwrap();
        assert!(!f9.active, "F9 Pause should be inactive for completed session");
        let f10 = km.fkeys.iter().find(|f| f.key == "F10").unwrap();
        assert!(!f10.active, "F10 Kill should be inactive for completed session");
    }
