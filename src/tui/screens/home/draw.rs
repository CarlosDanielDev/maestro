...
impl HomeScreen {
    ...
    pub(super) fn execute_selected_action(&self) -> ScreenAction {
        match self.selected_action {
            ...
            4 => ScreenAction::Push(TuiMode::Overview),
            5 => ScreenAction::Push(TuiMode::CostDashboard),
            6 => ScreenAction::Push(TuiMode::TokenDashboard),
            7 => ScreenAction::Push(TuiMode::Settings),
            8 => ScreenAction::CheckForUpdate,
            9 => ScreenAction::Quit,
            _ => ScreenAction::None,
        }
    }
