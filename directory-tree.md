...
| `src/tui/snapshot_tests/` | TUI snapshot test suite; 151+ tests across 19 views using `insta`; run with `cargo test tui::snapshot_tests`; update with `INSTA_UPDATE=always cargo test` or `cargo insta review` (Issues #16, #490, #526, #527, #539, #542, #543, #560, #568, #714, #715) |
