...
│   │   ├── snapshot_tests/                # TUI snapshot tests using insta (109 tests, 16 views)  [Issue #16, #490, #526, #527, #528, #539, #543, #560, #568]
...
| `src/tui/agent_graph/render.rs` | ratatui `Canvas` renderer; draws edges as `Line` shapes, nodes as `Rectangle` + label; sprite/abbrev rendering via `personalities` module; single-agent fallback card; 80×24 min-size guard; agent chip placement delegated to `label_placement::LabelPlacement`; file-arm labels placed via `label_placement::place_file_label` (Issues #526, #539, #567, #568) |
