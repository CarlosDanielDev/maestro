...
│   │   │   ├── settings_teams_parity.rs   # Parity snapshot tests for Teams tab: verifies schema renderer output (empty state + one-entry with bindings round-trip) at 80×24  [Issue #803]
