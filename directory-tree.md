...
│   │   ├── schema.rs                      # FieldSchema, FieldKind, TableSchema, DefaultValue, Validator types; pub(crate) validate_url_or_empty and validate_non_empty validators; 6 inline unit tests (path resolution, enum-domain check, help-text style, default-kind compatibility, no duplicate paths, validator purity)  [Issue #713]
...
│   │   ├── snapshot_tests/                # TUI snapshot tests using insta (143+ tests, 18 views)  [Issue #16, #490, #526, #527, #528, #539, #543, #560, #568, #569, #664, #714]
│   │   │   ├── mod.rs                     # Module declarations for snapshot test submodules; mod agent_graph, mod agent_graph_dispatcher, mod agent_graph_keybinding_hint, mod agent_personalities, mod activity_log_dispatch, mod completion_overlay, mod team_wizard, and mod schema_tab wired; make_failed_gates_session() fixture helper  [Issue #526, #527, #528, #539, #543, #560, #664, #714]
...
│   │           ├── schema_tab/            # Schema-driven settings renderer — builds SettingsField entries from a TableSchema; wired behind the schema_driven_settings feature flag (default off); no production tab consumes this module yet  [Issue #714]
...
│   │           │   └── schema_flag.rs     # Flag-wiring tests: schema_driven_settings is registered, default-off, and produces no observable change in field counts when toggled (no tab migrated yet)  [Issue #714]
...
| `src/tui/snapshot_tests/` | TUI snapshot test suite; 109 tests across 16 views using `insta`; run with `cargo test tui::snapshot_tests`; update with `INSTA_UPDATE=always cargo test` or `cargo insta review` (Issues #16, #490, #526, #527, #539, #542, #543, #560, #568) |
