...
│   │   │   ├── completion_pipeline.rs     # check_completions() config-driven gate evaluation with per-gate logging; persists worktree_path onto session at FailedGates transition  [Issue #40, #104, #560]
